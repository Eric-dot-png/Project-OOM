...
static constexpr auto qt_meta_stringdata_ZN11PrivateChatE = QtMocHelpers::stringData(
    "PrivateChat",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11PrivateChatE[] = {
...
Q_CONSTINIT const QMetaObject PrivateChat::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11PrivateChatE.offsetsAndSizes,
    qt_meta_data_ZN11PrivateChatE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11PrivateChatE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PrivateChat, std::true_type>,
        // method 'on_sendMsgButton_clicked'
...
void PrivateChat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_sendMsgButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *PrivateChat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11PrivateChatE.stringdata0))
